    ...
    return (
        <div className="container section-padding">
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                <h1 style={{ fontSize: '3.5rem', marginBottom: '2rem', letterSpacing: '-1px' }}>About Kartavya</h1>
                ...
                <h2 style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>Our Vision</h2>
                ...
                <h2 style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>The Team</h2>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '3rem', fontSize: '1.1rem' }}>
